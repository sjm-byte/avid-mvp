...
const collateralCases = [
  {
    ...
    body: "اگر سرمایه‌پذیر نسبت به انجام تعهدات خود کوتاهی کند. برای مثال کالای موردنظر را در سررسید توافق‌شده ارائه نکند، سرمایه‌گذار (خریدار کالا) می‌تواند از محل وثایق، عین همان کالا را از محل دیگری برای خود تهیه نماید.",
  },
  {
    title: "۲. عدم بازگرداندن سرمایه پس از پایان عملیات اقتصادی",
    body: "اگر عملیات اقتصادی پایان یافته و سود مشخص شده باشد اما سرمایه‌پذیر (فروشنده کالا) در سررسید مورد توافق سرمایه را بازنگرداند، در این صورت نیز می‌توان از محل وثایق مطالبه را وصل کرد.",
  },
];
    ...
    <div className="space-y-8">
      <div className="space-y-3">
        ...
        <p className="text-sm leading-relaxed text-justify text-muted-foreground">
          در این بخش با مهم‌ترین اصل بنیادین آوید که زیرساخت همه قراردادها
          می‌باشد و انواع ریسک‌ها آشنا می‌شوید.
        </p>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <blockquote className="rounded-md border-r-4 border-primary/40 bg-muted/40 px-4 py-3 text-sm font-medium leading-relaxed text-justify">
              «سرمایه‌گذار در صورتی مستحق دریافت سود است که ریسک اقتصادی طرح را
              ولو به میزان اندکی بپذیرد.»
            </blockquote>
            <p className="text-sm leading-relaxed text-justify text-muted-foreground">
              ...
              باشد. اگر سرمایه‌پذیر اصل مال را به‌صورت مطلق تضمین کند، از نظر ما
              ماهیت قرارداد به «قرض» تغییر یافته و در نتیجه تنها مستحق دریافت
              اصل سرمایه خواهد بود و نه بیشتر.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="rounded-lg border bg-muted/20 p-4">
                ...
                <p className="mt-2 text-sm leading-relaxed text-justify text-muted-foreground">
                  ...
                  معتبر و چندلایه چک تلاش می‌شود این ریسک پوشش داده شود.
                </p>
              </div>
              ...
              <div className="rounded-lg border bg-muted/20 p-4">
                ...
                <p className="mt-2 text-sm leading-relaxed text-justify text-muted-foreground">
                  ...
                  پیش‌خرید کند و در زمان سررسید قیمت بازار آن کالا به نصف کاهش
                  پیدا کند، زیان اقتصادی رخ داده است.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm leading-relaxed text-justify text-muted-foreground">
                سرمایه‌پذیر در دو حالت می‌تواند از محل اسناد
                ضمانتی اقدام کند:
              </p>
              <div className="space-y-3">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <p className="text-sm leading-relaxed text-justify text-muted-foreground">
              ...
              عملیات اقتصادی برداشته است. سرمایه‌گذاری از طریق آوید با
              وجود همه ریسک‌هایی که گفته شد به معنی ورود به دنیای پرتلاطم
              عملیات اقتصادی نیست. چراکه ما به‌جای ورود مستقیم به فعالیت‌های
              پرریسک و عملیاتی، سرمایه را در بخشی از پروژه که حاشیه امن
              محسوب می‌شود وارد می‌کنیم تا عملاً ریسک اصلی عملیات متوجه
              سرمایه‌گذار نباشد. بنابراین هرچند ریسک صفر نیست و وجود دارد
              اما میزان آن با ریسک یک کسب‌وکار یا فعالیت اقتصادی مستقیم
              بسیار متفاوت است. برای مثال، در قرارداد پیش‌خرید کالا
              سرمایه‌گذار کالا را با تخفیف خریده است و فروشنده موظف است
