        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <p className="text-sm leading-relaxed text-justify text-muted-foreground">
              ...
              عملیاتی، سرمایه را در بخشی از پروژه که حاشیه امنی محسوب
              می‌شود وارد می‌کنیم تا عملاً ریسک اصلی عملیات متوجه
              سرمایه‌گذار نباشد. بنابراین ریسک
              وجود دارد، اما جنس آن با ریسک یک کسب‌وکار یا فعالیت اقتصادی
              مستقیم بسیار متفاوت است. برای مثال، در قرارداد پیش‌خرید
              کالا، سرمایه‌گذار کالا را با تخفیف خریده است و فروشنده موظف
              است کالا را چند ماه تحویل دهد. اگر در زمان تحویل، قیمت کالا
              کاهش پیدا کند، زیان کاهش قیمت متوجه سرمایه‌گذار خواهد بود.
              ناگفته پیداست که ریسک کاهش قیمت یک کالا در شرایط تورمی، ریسک
              ناچیزی است.
            </p>
          </CardContent>
        </Card>
