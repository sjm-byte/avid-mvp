      ...
      <CardContent className="space-y-6">
        <div className="rounded-lg border border-primary/20 bg-muted/40 p-4">
          ...
          <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
            در حالت نمایشی نیازی به حساب واقعی نیست. داده‌ها در مرورگر شما
            (کوکی) نگهداری می‌شوند. پول واقعی جابه‌جا نمی‌شود و آوید درگاه
            پرداخت نیست؛ فقط ثبت حسابداری و پیگیری مشارکت است.
          </p>
