...
export const metadata: Metadata = {
  title: "سابقه عملکرد و نتایج — آوید",
  description:
    "گزارش پروژه‌های خاتمه‌یافته آوید، وضعیت تسویه و مقایسه پیش‌بینی با واقعیت.",
};
    ...
    <div className="container mx-auto max-w-7xl px-4 py-12 md:py-16">
      <header className="max-w-3xl space-y-4">
        <p className="text-sm text-muted-foreground">
          بخش اول شفافیت — سابقه عملکرد و نتایج
        </p>
        ...
        <p className="text-base leading-relaxed text-muted-foreground">
          ...
          پروژه‌ها می‌تواند به شما در تصمیم‌گیری کمک کند. این صفحه یکی از سه
          بخش شفافیت آوید است؛ روش کار و انواع قراردادها را نیز در بخش‌های
          مرتبط مطالعه کنید.
        </p>
        <p className="text-base leading-relaxed text-muted-foreground">
      ...
      <div className="mt-8 max-w-5xl">
        <TransparencyHubNav current="/transparency" />
      </div>
      ...
      <TransparencyNextSteps current="transparency" />
    </div>
  );
}
